...
class MigrationPage {
    ...
    async showDependencies(produitIndex) {
        ...
        // Construire le graphique visuel de lineage avec LineageModal
        const lineageModal = new LineageModal({
            flux: this.flux,
            shores: this.shores,
            projetsDSS: this.projetsDss,
            dataflows: this.dataflows,
            tablesMh: this.tablesMh
        });
        const lineageGraph = lineageModal.renderLineageGraph(produit, fluxProduits);
        ...
        lineageModal.drawLineageConnections(lineageGraph.relations);
    }
